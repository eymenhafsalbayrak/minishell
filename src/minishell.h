...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/05 14:20:26 by ealbayra          #+#    #+#             */
/*   Updated: 2023/11/08 14:30:14 by ealbayra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// void		ft_word_count2(char const *cmd, int i);
void		_create_dup(t_shell *m_shell);
void		ft_newlstiter(t_list *lst, void (*f)(), t_shell *shell);
void		fd_init(int *fd);
void		create_dup_two(t_mparse *data1, int *fd,
				int fd_index, t_shell *m_shel);
void		create_dup_one(t_mparse *data1, int *fd);
...
void		get_env_to_lexlist(t_lexer **lex_list, t_shell *m_shell);
